...
class td_config {
    ...
    static function on_td_global_after_config() {
		...
		td_api_single_template::add('single_template_14',
            array(
                'file' => td_global::$get_template_directory . '/single_template_14.php',
                'text' => 'Single template 14',
                'img' => td_global::$get_template_directory_uri . '/images/panel/single_templates/single_template_14.png',
                'show_featured_image_on_all_pages' => true, //shows the featured image on all the pages
                'bg_disable_background' => false,          // disable the featured image
                'bg_box_layout_config' => 'auto',                // auto | td-boxed-layout | td-full-layout
                'bg_use_featured_image_as_background' => false   // uses the featured image as a background
		...
		td_api_single_template::add('single_template_15',
            array(
                'file' => td_global::$get_template_directory . '/single_template_15.php',
                'text' => 'Single template 15',
                'img' => td_global::$get_template_directory_uri . '/images/panel/single_templates/single_template_15.png',
                'show_featured_image_on_all_pages' => true, //shows the featured image on all the pages
                'bg_disable_background' => false,          // disable the featured image
                'bg_box_layout_config' => 'auto',                // auto | td-boxed-layout | td-full-layout
                'bg_use_featured_image_as_background' => false   // uses the featured image as a background
    ...
    td_api_single_template::add('single_template_16',
            array(
                'file' => td_global::$get_template_directory . '/single_template_16.php',
                'text' => 'Single template 15',
                'img' => td_global::$get_template_directory_uri . '/images/panel/single_templates/single_template_16.png',
                'show_featured_image_on_all_pages' => true, //shows the featured image on all the pages
                'bg_disable_background' => false,          // disable the featured image
                'bg_box_layout_config' => 'auto',                // auto | td-boxed-layout | td-full-layout
                'bg_use_featured_image_as_background' => false   // uses the featured image as a background
