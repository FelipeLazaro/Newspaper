                    ...
                    ?>
                        ...
                        <div class="td-pb-span4 td-main-sidebar" role="complementary">
                            <div class="td-ss-main-sidebar">
								...
								<!-- Encuesta -->
								<div class="sg-instructions" style="border-bottom: 1px solid #ccc;
									color: #a70a0b;
									...
									line-height: 30px;
									overflow: hidden;
									text-transform: uppercase;">América vs Guadalajara	</div>									
								<script type="text/javascript">document.write("<scr"+"ipt type=\"text/javascript\" src=\"//www.surveygizmo.com/s3/polljs/2788799-8T2N0TJXOBAWPZ6DSNB8Z1XUX1MO7J?cookie="+document.cookie.match(/sg-response-2788799/gi)+"\"></scr"+"ipt>");</script>
								<!-- -->
								<!-- Twitter-->
